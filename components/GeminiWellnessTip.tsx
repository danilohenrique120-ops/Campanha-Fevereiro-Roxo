    ...
    const fetchTip = async () => {
      try {
        ...
        const response = await ai.models.generateContent({
          ...
          contents: "Dê uma dica curta de 1 frase (máximo 15 palavras) de bem-estar mental para um trabalhador de ambiente industrial hoje. Seja inspirador e use um emoji.",
          config: {
            systemInstruction: "Você é um coach de bem-estar focado em saúde mental no trabalho.",
            temperature: 0.8,
          },
        });
