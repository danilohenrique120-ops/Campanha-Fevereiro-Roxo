        ...
        <div className="bg-purple-50 p-6 rounded-xl text-left mb-6 border border-purple-100">
          ...
          <ul className="space-y-3 text-sm text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span><strong>Canais de Ajuda:</strong> Procure o suporte médico ou psicológico da sua unidade.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary font-bold">👷</span>
              <span><strong>CIPEIRO:</strong> Procure um representante da CIPA em sua área para orientação.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary font-bold">🗣️</span>
              <span><strong>Advocates:</strong> Converse com um Advocate de saúde mental.</span>
            </li>
          </ul>
        </div>
